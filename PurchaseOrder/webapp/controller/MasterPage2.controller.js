sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.purchaseOrder.controller.MasterPage2", {
		...
		onInit: function() {
			...
			this.oRouter.getTarget("MasterPage2").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "sap_List_Page_0-content-sap_m_ObjectList-1620678643937",
				"groups": ["items"]
			}];
